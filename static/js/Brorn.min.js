...
const MODAL_DEF = `<div id="MODAL_BODYBRN" class="x-modal-content x-animate-top x-round-large">
	<div id="MODAL_BRN_HEADER" class="x-container x-padding x-round-large">
		<span class="x-large x-hover-red x-button x-display-topright fa fa-times-rectangle-o x-text-red x-round-large" onclick="this.parentNode.parentNode.parentNode.style.display='none';DESTROY_MODAL(this.parentNode.parentNode.parentNode)">
		</span>
		<div style="">
			<span>
				<span class="x-xlarge">
