...
function $dialog(args){
	...
	var ___actions = function(__btns_act_){
...
function web_safe_encode(UNWEBSAFE){
	return UNWEBSAFE.replaceAll("!",'%21').replaceAll('"','%22').replaceAll("#",'%23').replaceAll("$",'%24').replaceAll("&",'%26').replaceAll("'",'%27').replaceAll("(",'%28').replaceAll(")",'%29').replaceAll("*",'%2A').replaceAll("+",'%2B').replaceAll(",",'%2C').replaceAll("-",'%2D').replaceAll(".",'%2E').replaceAll("/",'%2F').replaceAll(":",'%3A').replaceAll(";",'%3B').replaceAll("<",'%3C').replaceAll("=",'%3D').replaceAll(">",'%3E').replaceAll("?",'%3F').replaceAll("@",'%40').replaceAll("[",'%5B').replaceAll("\\",'%5C').replaceAll("]",'%5D').replaceAll("^",'%5E').replaceAll("_",'%5F').replaceAll("`",'%60').replaceAll("{",'%7B').replaceAll("|",'%7C').replaceAll("}",'%7D').replaceAll("~",'%7E')

}


function web_safe_decode(WEBSAFE){
	return WEBSAFE.replaceAll('%21',"!").replaceAll('%22','"').replaceAll('%23',"#").replaceAll('%24',"$").replaceAll('%26',"&").replaceAll('%27',"'").replaceAll('%28',"(").replaceAll('%29',")").replaceAll('%2A',"*").replaceAll('%2B',"+").replaceAll('%2C',",").replaceAll('%2D',"-").replaceAll('%2E',".").replaceAll('%2F',"/").replaceAll('%3A',":").replaceAll('%3B',";").replaceAll('%3C',"<").replaceAll('%3D',"=").replaceAll('%3E',">").replaceAll('%3F',"?").replaceAll('%40',"@").replaceAll('%5B',"[").replaceAll('%5C',"\\").replaceAll('%5D',"]").replaceAll('%5E',"^").replaceAll('%5F',"_").replaceAll('%60',"`").replaceAll('%7B',"{").replaceAll('%7C',"|").replaceAll('%7D',"}").replaceAll('%7E',"~")
...
function dhm(ms) {
	...
	if(_int(minutes)!=0){mins_= minutes+" minute/s, "}
	else{mins_="Just Now"}
	if(_int(hours)!=0){hrs_= hours+" hour/s, "}
	// else{mins_=""}
	if(_int(days)!=0){days_= days+" Day/s, "}
	// else{hrs_=""}
