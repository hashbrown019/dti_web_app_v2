...
function $dialog(args){
	...
	var type_ls__ = {"done":"blue","success":"green","error":"red","warning":"yellow","neutral":"grey"};
	var type_ls__ICON = {"done":"check-square-o","success":"check-square-o","error":"minus-circle","warning":"exclamation-triangle","neutral":"info-circle"};
...
function __dd_on_search(itms,option_display){
	...
	var re__item_ind = all_items_in_dd
	if(val.length<=1){
		for (var i = 0; i < re__item_ind.length; i++) {
			re__item_ind[i].style.display = option_display
		}
	}
}
