...
def excel_upload_open2(path):  
	...
	for row in data[5:]:
		...
		form_2_dip_alignment = row[4]                                                               
		form_2_name_owner_manager = row[5]                                                   
		form_2_sex_owner_manager = row[6]                                                         
		form_2_sector_owner_manager = row[7]                                                   
		form_2_business_owner_manager = row[8]                                                                                                       
		form_2_partner_fo_engaged = row[9]                                                  
		form_2_chairperson_manager = row[10]                                                     
		form_2_sex_chairperson_manager = row[11]                                                                                                  
		form_2_sector_chairperson_manager = row[12]                                                                                   
		form_2_office_address_province = row[13]                                                                                      
		form_2_total_number_fo = row[14]                                                                                           
		form_2_male = row[15]                                                                                                                                             
		form_2_female = row[16]                                                                                           
		form_2_pwde = row[17]                                                                                     
		form_2_youth = row[18]                                                                                             
		form_2_ip = row[19]                                                                                                                                            
		form_2_sc = row[20]                                                                                                                                        
		form_2_address_of_fo_members = row[21]                                                   
		form_2_hectares_covered = row[22]                                            
		form_2_cpa_date_signing = row[23]                                          
		form_2_cpa_date_expiration = row[24]                                                                                            
		form_2_days_remaining = row[25]                                                                                           
		form_2_date_renewed = row[26]                                         
		form_2_notable_cpa_incentives = row[27]                                                                                     
		form_2_activity_agreements = row[28]                                             
		form_2_date_conducted = row[29]                                                                           
		form_2_remarks_status = row[30]                                                                                                                                  
		filename = UPLOAD_NAME

		querycsv = ("INSERT INTO dcf_implementing_unit ( upload_by,form_2_name_dip,form_2_rcus,form_2_pcu,form_2_commodity,form_2_dip_alignment,form_2_name_owner_manager,form_2_sex_owner_manager,form_2_sector_owner_manager,form_2_business_owner_manager,form_2_partner_fo_engaged,form_2_chairperson_manager,form_2_sex_chairperson_manager,form_2_sector_chairperson_manager,form_2_office_address_province,form_2_total_number_fo,form_2_male,form_2_female,form_2_pwde,form_2_youth,form_2_ip,form_2_sc,form_2_address_of_fo_members,form_2_hectares_covered,form_2_cpa_date_signing,form_2_cpa_date_expiration,form_2_days_remaining,form_2_date_renewed,form_2_notable_cpa_incentives,form_2_activity_agreements,form_2_date_conducted,form_2_remarks_status,filename) VALUES ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".
		format(upload_by,form_2_name_dip,form_2_rcus,form_2_pcu,form_2_commodity,form_2_dip_alignment,form_2_name_owner_manager,form_2_sex_owner_manager,form_2_sector_owner_manager,form_2_business_owner_manager,form_2_partner_fo_engaged,form_2_chairperson_manager,form_2_sex_chairperson_manager,form_2_sector_chairperson_manager,form_2_office_address_province,form_2_total_number_fo,form_2_male,form_2_female,form_2_pwde,form_2_youth,form_2_ip,form_2_sc,form_2_address_of_fo_members,form_2_hectares_covered,form_2_cpa_date_signing,form_2_cpa_date_expiration,form_2_days_remaining,form_2_date_renewed,form_2_notable_cpa_incentives,form_2_activity_agreements,form_2_date_conducted,form_2_remarks_status,filename))
		insert=db.do(querycsv)
		print(insert)
		print("===============================================")
