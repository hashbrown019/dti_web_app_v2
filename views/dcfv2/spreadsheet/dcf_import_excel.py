...
def excel_upload_open3(path):  
	...
	for row in data[5:]:
		upload_by = session["USER_DATA"][0]['id']
		form_3_classification = row[0]
		form_3_types_of_bdsp = row[1]
		form_3_orgfirm = row[2]
		form_3_contact_person = row[3]
		form_3_sex = row[4]
		form_3_office_addr = row[5]
		form_3_email = row[6]
		form_3_breif_description = row[7]
		phone = row[8]
		form_3_choices = row[9]
		form_3_preferred_region = row[10]
		form_3_preferred_province = row[11]
		form_3_name = row[12]
