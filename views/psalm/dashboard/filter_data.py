...
def data_filter(request):
    ...
    coffee_singlesolesql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coffee%' AND form_interprise='Single/Sole'")
    cacao_singlesolesql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%cacao%' AND form_interprise='Single/Sole'")
    coconut_singlesolesql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coconut%' AND form_interprise='Single/Sole'")
    pfn_singlesolesql=db.select("SELECT industry_cluster, form_interprise FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND form_interprise='Single/Sole'")

    coffee_partnershipsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coffee%' AND form_interprise='partnership'")
    cacao_partnershipsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%cacao%' AND form_interprise='partnership'")
    coconut_partnershipsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coconut%' AND form_interprise='partnership'")
    pfn_partnershipsql=db.select("SELECT industry_cluster, form_interprise FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND form_interprise='partnership'")

    coffee_corporationsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coffee%' AND form_interprise='corporation'")
    cacao_corporationsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%cacao%' AND form_interprise='corporation'")
    coconut_corporationsql=db.select("SELECT `industry_cluster`,`form_interprise` from form_c where industry_cluster LIKE '%coconut%' AND form_interprise='corporation'")
    pfn_corporationsql=db.select("SELECT industry_cluster, form_interprise FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND form_interprise='corporation'")

    coffee_otherql=db.select("SELECT `industry_cluster`,`interprise_other` from form_c where industry_cluster LIKE '%coffee%' AND interprise_other != '' ")
    cacao_othersql=db.select("SELECT `industry_cluster`,`interprise_other` from form_c where industry_cluster LIKE '%cacao%' AND interprise_other != '' ")
    coconut_othersql=db.select("SELECT `industry_cluster`,`interprise_other` from form_c where industry_cluster LIKE '%coconut%' AND interprise_other != '' ")
    ...
    coffee_malesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%coffee%' AND sex='male'")
    cacao_malesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%cacao%' AND sex='male'")
    coconut_malesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%coconut%' AND sex='male'")
    pfn_malesql=db.select("SELECT industry_cluster, sex FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND sex='male'")

    coffee_femalesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%coffee%' AND sex='female'")
    cacao_femalesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%cacao%' AND sex='female'")
    coconut_femalesql=db.select("SELECT `industry_cluster`,`sex` from form_c where industry_cluster LIKE '%coconut%' AND sex='female'")
    pfn_femalesql=db.select("SELECT industry_cluster, sex FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND sex='female'")
    #----------------------------------------
    ...
    adn_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del norte%' AND industry_cluster LIKE '%coffee%'")
    ads_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del sur%' AND industry_cluster LIKE '%coffee%'")
    sds_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%surigao del sur%' AND industry_cluster LIKE '%coffee%'")
    magui_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%maguindanao%' AND industry_cluster LIKE '%coffee%'")
    ns_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%northern samar%' AND industry_cluster LIKE '%coffee%'")
    leyte_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE 'leyte%' AND industry_cluster LIKE '%coffee%'")
    sleyte_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%southern leyte%' AND industry_cluster LIKE '%coffee%'")
    mo_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%misamis oriental%' AND industry_cluster LIKE '%coffee%'")
    bukd_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%bukidnon%' AND industry_cluster LIKE '%coffee%'")
    ldn_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%lanao del norte%' AND industry_cluster LIKE '%coffee%'")
    nc_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%north cotabato%' AND industry_cluster LIKE '%coffee%'")
    sk_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sultan kudarat%' AND industry_cluster LIKE '%coffee%'")
    srng_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sarangani%' AND industry_cluster LIKE '%coffee%'")
    zdn_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del norte%' AND industry_cluster LIKE '%coffee%'")
    zs_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga sibugay%' AND industry_cluster LIKE '%coffee%'")
    zds_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del sur%' AND industry_cluster LIKE '%coffee%'")
    ddo_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao de oro%' AND industry_cluster LIKE '%coffee%'")
    do_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao oriental%' AND industry_cluster LIKE '%coffee%'")
    ddn_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del norte%' AND industry_cluster LIKE '%coffee%'")
    dds_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del sur%' AND industry_cluster LIKE '%coffee%'")
    doc_coffeesql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao occidental%' AND industry_cluster LIKE '%coffee%'")

    adn_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del norte%' AND industry_cluster LIKE '%cacao%'")
    ads_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del sur%' AND industry_cluster LIKE '%cacao%'")
    sds_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%surigao del sur%' AND industry_cluster LIKE '%cacao%'")
    magui_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%maguindanao%' AND industry_cluster LIKE '%cacao%'")
    ns_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%northern samar%' AND industry_cluster LIKE '%cacao%'")
    leyte_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE 'leyte%' AND industry_cluster LIKE '%cacao%'")
    sleyte_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%southern leyte%' AND industry_cluster LIKE '%cacao%'")
    mo_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%misamis oriental%' AND industry_cluster LIKE '%cacao%'")
    bukd_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%bukidnon%' AND industry_cluster LIKE '%cacao%'")
    ldn_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%lanao del norte%' AND industry_cluster LIKE '%cacao%'")
    nc_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%north cotabato%' AND industry_cluster LIKE '%cacao%'")
    sk_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sultan kudarat%' AND industry_cluster LIKE '%cacao%'")
    srng_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sarangani%' AND industry_cluster LIKE '%cacao%'")
    zdn_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del norte%' AND industry_cluster LIKE '%cacao%'")
    zs_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga sibugay%' AND industry_cluster LIKE '%cacao%'")
    zds_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del sur%' AND industry_cluster LIKE '%cacao%'")
    ddo_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao de oro%' AND industry_cluster LIKE '%cacao%'")
    do_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao oriental%' AND industry_cluster LIKE '%cacao%'")
    ddn_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del norte%' AND industry_cluster LIKE '%cacao%'")
    dds_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del sur%' AND industry_cluster LIKE '%cacao%'")
    doc_cacaosql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao occidental%' AND industry_cluster LIKE '%cacao%'")

    adn_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del norte%' AND industry_cluster LIKE '%coconut%'")
    ads_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%agusan del sur%' AND industry_cluster LIKE '%coconut%'")
    sds_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%surigao del sur%' AND industry_cluster LIKE '%coconut%'")
    magui_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%maguindanao%' AND industry_cluster LIKE '%coconut%'")
    ns_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%northern samar%' AND industry_cluster LIKE '%coconut%'")
    leyte_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE 'leyte%' AND industry_cluster LIKE '%coconut%'")
    sleyte_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%southern leyte%' AND industry_cluster LIKE '%coconut%'")
    mo_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%misamis oriental%' AND industry_cluster LIKE '%coconut%'")
    bukd_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%bukidnon%' AND industry_cluster LIKE '%coconut%'")
    ldn_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%lanao del norte%' AND industry_cluster LIKE '%coconut%'")
    nc_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%north cotabato%' AND industry_cluster LIKE '%coconut%'")
    sk_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sultan kudarat%' AND industry_cluster LIKE '%coconut%'")
    srng_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%sarangani%' AND industry_cluster LIKE '%coconut%'")
    zdn_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del norte%' AND industry_cluster LIKE '%coconut%'")
    zs_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga sibugay%' AND industry_cluster LIKE '%coconut%'")
    zds_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%zamboanga del sur%' AND industry_cluster LIKE '%coconut%'")
    ddo_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao de oro%' AND industry_cluster LIKE '%coconut%'")
    do_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao oriental%' AND industry_cluster LIKE '%coconut%'")
    ddn_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del norte%' AND industry_cluster LIKE '%coconut%'")
    dds_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao del sur%' AND industry_cluster LIKE '%coconut%'")
    doc_coconutsql=db.select("SELECT `business_addr`,`industry_cluster` from form_c where business_addr LIKE '%davao occidental%' AND industry_cluster LIKE '%coconut%'")

    adn_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%agusan del norte%'")
    ads_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%agusan del sur%'")
    sds_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%surigao del sur%'")
    magui_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%maguindanao%'")
    ns_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%northern samar%'")
    leyte_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%leyte%'")
    sleyte_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%southern leyte%'")
    mo_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%misamis oriental%'")
    bukd_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%bukidnon%'")
    ldn_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%lanao del norte%'")
    nc_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%north cotabato%'")
    sk_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%sultan kudarat%'")
    srng_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%sarangani%'")
    zdn_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%zamboanga del norte%'")
    zs_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%zamboanga sibugay%'")
    zds_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%zamboanga del sur%'")
    ddo_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%davao de oro%'")
    do_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%davao oriental%'")
    ddn_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%davao del norte%'")
    dds_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%davao del sur%'")
    doc_pfnsql=db.select("SELECT industry_cluster, business_addr FROM `form_c` WHERE (industry_cluster LIKE '%PFN%' OR (industry_cluster !='cacao' AND industry_cluster !='coconut' AND industry_cluster !='coffee' AND industry_cluster != '' AND industry_cluster!= ' ' AND industry_cluster NOT LIKE '%cacao%' AND industry_cluster NOT LIKE '%coconut%' AND industry_cluster NOT LIKE '%coffee%')) AND business_addr LIKE '%davao occidental%'")
    #----------------------------------------
