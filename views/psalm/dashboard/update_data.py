...
def update(request):
    ...
    if request.method == 'POST':
        ...
        sql = """UPDATE form_c
               SET name='{}', position_firm='{}', member_indegenous='{}', sex='{}', age='{}', contact_details='{}', email_add='{}', vc_stakeholders='{}', industry_cluster='{}', reg_businessname='{}', business_addr='{}', form_interprise='{}', interprise_other='{}', issued_by_business_reg='{}', expired_date_business_reg='{}', issued_by_product_reg='{}', expired_date_product_reg='{}', issued_by_cert_reg='{}', expired_date_cert_reg='{}', issued_by_lic_op='{}', expired_date_lic_op='{}', iso_cert_specific='{}', issued_by_iso_cert='{}', expired_date_iso_cert='{}',
