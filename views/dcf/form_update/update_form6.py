...
def updateform6(request):
    ...
    if request.method == 'POST':
        ...
        form_6_product_developed = request.form['form_6_product_developed']
        form_6_date_launched_to_market = request.form['form_6_date_launched_to_market']
        form_6_improved_product = request.form['form_6_improved_product']
        form_6_type_of_product_improvement = request.form['form_6_type_of_product_improvement']
