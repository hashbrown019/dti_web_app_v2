...
def insert_form3(request):
    if request.method == "POST":
        ...
        form_3_preferred_province =', '.join(request.form.getlist('form_3_preferred_province[]') )
